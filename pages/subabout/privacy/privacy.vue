    ...
    <view class="container">
      <view class="card">
        ...
        <view class="paragraph">
          本《隐私政策》适用于“岁序“本应用”）。本应用由开发者（以下简称“我们”）提供与运营。
        ...
        <view class="section">
          ...
          <view class="item">• 重要日子/纪念日信息：你输入的标题、日期、备注等，用于展示与计算“还有/已经”天数。</view>
        ...
        <view class="section">
          ...
          <view class="item">• 相机权限：当你选择拍摄图片并用于背景/封面等时使用。</view>
          <view class="item">• 相册/存储权限：当你从相册选择图片用于背景/封面等时使用。</view>
