    ...
    <view class="container">
      <view class="card">
        ...
        <view class="paragraph">
          欢迎你使用“岁序·Chrona”（以下简称“本应用”）。本《用户协议》（以下简称“本协议”）由你与本应用开发者（以下简称“我们”）共同订立。
          你在使用本应用前应当仔细阅读并充分理解本协议全部条款。你点击“同意并继续”或实际使用本应用，即表示你已阅读并同意接受本协议的约束。
        </view>

        <view class="section">
          <view class="section-title">一、协议范围与接受</view>
          <view class="item">1.1 本协议适用于你下载、安装、注册、登录及使用本应用提供的所有功能与服务。</view>
        ...
        <view class="section">
          <view class="section-title">三、账号与设备</view>
